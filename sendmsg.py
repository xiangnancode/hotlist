...
if __name__ == '__main__':
    ...
    for key, val in hourlyRank.items():
        ...
        if (keymax - keymin >= 20 and mini > maxi):
            msg += 'Rank of '+key+' has raised from '+str(keymax)+' ('+timeline[maxi]+') to '+str(keymin)+' ('+timeline[mini]+')\n'
    if (msg != ''):
        sendEmail2(['phoppfw@gmail.com', 'bengbengzz1220@gmail.com','jesusisking1@gmail.com'], msg)
        #print msg
